...
namespace GOFI {
    namespace Shortcuts {
        ...
        const uint[] ROW_MOVE_UP = {Gdk.Key.Control_L, Gdk.Key.Z};
        const uint[] ROW_MOVE_DOWN = {Gdk.Key.Control_L, Gdk.Key.Q};
        const uint[] SWITCH_PAGE_LEFT = {Gdk.Key.Shift_L, Gdk.Key.Q};
        const uint[] SWITCH_PAGE_RIGHT = {Gdk.Key.Shift_L, Gdk.Key.Z};
        const uint[] NEXT_TASK = {Gdk.Key.Z};
        const uint[] PREV_TASK = {Gdk.Key.Q};
